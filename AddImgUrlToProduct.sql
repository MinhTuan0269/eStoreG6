...
ALTER TABLE [Roles] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Products] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Payments] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Orders] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [OrderDetails] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Members] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [Categories] ADD [Status] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

UPDATE [Roles] SET [Status] = CAST(1 AS bit)
WHERE [RoleId] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250724043919_AddStatusToEntities', N'8.0.5');
GO
...
ALTER TABLE [Products] ADD [ImgUrl] nvarchar(max) NOT NULL DEFAULT N'';
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250724062459_AddImgUrlToProduct', N'8.0.5');
GO
